     ...
     body: GestureDetector(
      ...
      child: Column(
       ...
       Center(
         ...
         Text('채널명',style: Theme.of(context).textTheme.subtitle1),
         Text('구독자수',style: Theme.of(context).textTheme.subtitle1),
         Text('주요 플랫폼',style: Theme.of(context).textTheme.subtitle1)
