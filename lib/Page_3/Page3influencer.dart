...
class Page3influencer extends StatefulWidget {

  const Page3influencer({Key? key}) : super(key: key);

  @override
  State<Page3influencer> createState() => _Page3influencerState();
}

class _Page3influencerState extends State<Page3influencer> {
  String you = "";
  String yourimage = "";
  String email="";
